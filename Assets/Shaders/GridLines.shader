Shader "Graph/GridLines"
{
   Properties
   {
      ...
      _SecondaryFadeInSpeed("Secondary Fade In Speed", Range(0.25, 4)) = 0.5
      _ColorInterpolationFactor("Color Interpolation Factor", Range(0.25, 6)) = 3
   }
   SubShader
   {
      ...
      Pass
      {
         ...
         fixed4 lerp(fixed4 from, fixed4 to, float t) {
